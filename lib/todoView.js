(function (global, factory) {
  ...
  _todoEvents.todoEvent.subscribe('startSync', onStartSync);
  _todoEvents.todoEvent.subscribe('itemUpdate', onitemUpdate);
  ...
  function onFilterChange(e) {
    ...
    _todoEvents.todoEvent.publish('onSyncRecieve', data);
  }
  ...
  function onTitleClick(e) {
    ...
    var sortedContent = _todoEvents.todoEvent.getTodoRows();
    if (!descending) {
    ...
    _todoEvents.todoEvent.setTodoRows(sortedContent);
  ...
  function onAdd() {
    ...
    if (todoInput.value.trim() === '') {
      ...
      _todoEvents.todoEvent.publish('itemAdd', data);
    }
  }
  ...
  function onDelete(ele) {
    ...
    _todoEvents.todoEvent.publish('itemDelete', data);
  }
  /**
  ...
  function onItemChange(e) {
    ...
    _todoEvents.todoEvent.publish('itemChange', data);
  }
  ...
  function onitemUpdate() {
    ...
    var pages = Math.ceil(_todoEvents.todoEvent.getTodoRows().length / 10);
    var rows = _todoEvents.todoEvent.getTodoRows().slice((currentPage - 1) * 10, currentPage * 10);
    todoInput.value = '';
    var todoLists = '';
    content.innerHTML = '';
